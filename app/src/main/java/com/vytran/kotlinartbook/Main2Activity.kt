...
class Main2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (info.equals("new")) {
            val background = BitmapFactory.decodeResource(applicationContext.resources, R.drawable.tap)
    ...
    fun select(view: View) {
        //Open a dialog to ask for permission
        //IF NO
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        //IF user said no and press for permission again and said yes
        if (requestCode == 2) {
